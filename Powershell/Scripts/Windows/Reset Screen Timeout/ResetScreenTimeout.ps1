...
Set-RegistryValueForAllUsers -RegistryInstance @{'Name' = 'ScreenSaveTimeOut'; 'Type' = 'String'; 'Value' = '0'; 'Path' = 'SOFTWARE\Policies\Microsoft\Windows\Control Panel\Desktop'}