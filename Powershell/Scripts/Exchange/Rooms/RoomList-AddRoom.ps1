<#
.DESCRIPTION
    This script will add an existing room to a specific Room List.
.NOTES
...
Try {
  ...
  Add-DistributionGroupMember -Identity "$RoomList" -Member $RoomEmail
